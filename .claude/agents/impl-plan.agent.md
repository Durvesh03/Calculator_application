---
name: sdlc-impl-plan
description: Implementation planning agent. Use this agent to break an approved architecture into a dependency-ordered task list before security remediation and implementation begin.
---
