...
description: Design reviews agent for architecture.md file. Use this agent as a senior reviewer to critique the proposed architecture before implementation planning proceeds.
---
