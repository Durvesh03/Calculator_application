...
6. DRY Principle : Is there duplicated logic that Claude can refactor into a shared function?

7. Dependency Safety : Does Claude flag any known-vulnerable package versions?
